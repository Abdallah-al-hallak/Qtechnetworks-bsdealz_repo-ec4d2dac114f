...
class SignupForm1State extends State<SignupForm1> {
  ...
  TextboxPhone phoneet = TextboxPhone(
      margin: 5,
      marginh: 20,
  ...
  TextboxPassword repass = TextboxPassword(
  ...
  String token = "";
  BaseEditText email = BaseEditText(
      text: "Email",
      margin: 5,
      marginh: 20,
      focusNode: FocusNode(),
      ...
      width: 305,
      height: 55);
  BaseEditText fname = BaseEditText(
      text: "First Name",
      margin: 0,
      marginh: 20,
      focusNode: FocusNode(),
      ...
      width: 305,
      height: 55);
  BaseEditText lname = BaseEditText(
      text: "Last Name",
      margin: 0,
      marginh: 20,
      focusNode: FocusNode(),
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
        ...
        child: ListView(children: <Widget>[
          ...
          Container(margin: const EdgeInsets.all(10), child: fname),
          Container(margin: const EdgeInsets.all(10), child: lname),

          Container(margin: const EdgeInsets.all(10), child: email),
          Container(margin: const EdgeInsets.all(10), child: phoneet),
          pass,
          repass,
          Container(
            height: 100,
            ...
            onPressed: () async {
              if (validateForm([fname, lname, email], [pass, repass])) {
                ...
                if (phoneet.controller.text.length == 9) {
                  ...
                  RefreshApp.of(context)!.phone =
                      phoneet.countryCode.toString() +
                          phoneet.controller.text.toString();
                  RefreshApp.of(context)!.password =
                      pass.controller.text.toString();
                  ...
                  MainDialog.showMyDialog(
                      MainDialog(
                        title: "Failed",
                        text: "Dismiss",
                        descriptions: "your phone not valid",
  ...
  register() async {
    ...
    var responce = await dio.post("/register", data: {
      ...
      if (HttpAPI().APIValidateResponce(value)) {
        ...
        MainDialog.showMyDialog(
            MainDialog(
                ...
                descriptions: "continue to login",
                text: "",
  ...
  requestOTP() async {
    Dio dio = HttpAPI().Inisalize(context);
    var responce = await dio.post("/requestotp", data: {
      "phone": RefreshApp.of(context)!.phone.toString(),
    }).then((value) {
      if (HttpAPI().APIValidateResponce(value)) {
        EasyLoading.dismiss();
        ...
        MainDialog.showMyDialog(
            MainDialog(
                title: "Register Error",
                descriptions: "already exists email",
                text: "",
                type: DialogType.ERROR,
                customWidget: Container()),
            context);
