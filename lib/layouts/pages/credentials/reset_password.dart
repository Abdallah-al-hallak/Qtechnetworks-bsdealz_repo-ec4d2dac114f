...
class ResetPasswordForm1State extends State<ResetPasswordForm1> {
  ...
  Widget build(BuildContext context) {
    ...
    TextboxPassword passwordEt=TextboxPassword(text:"New password",margin: 20,marginh: 20,controller: TextEditingController(), validator: '',focusNode:FocusNode());
    TextboxPassword resetpasswsordEt=TextboxPassword(text:"Confirm new password",margin: 20,marginh: 20,controller: TextEditingController(), validator: '',focusNode:FocusNode());
            ...
            child: ListView(
                ...
                children: <Widget>[
                  ...
                  MainButton(
                    ...
                    if( Validator.validateForm(context,[],[passwordEt,resetpasswsordEt,])) {
                      Dio dio=HttpAPI().Inisalize(context);
                      var responce = await dio.post("/resetpassword",
                          data: { "password": passwordEt.controller.text.toString(),});
