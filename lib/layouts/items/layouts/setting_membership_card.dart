...
class SettingMembershipCard extends StatefulWidget
...
class _SettingMembershipCardState extends State<SettingMembershipCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        onTap: () {},
        child: SettingMembershipCardSingle(
            height: widget.height, width: widget.width, text: "555"));
  }
}
...
class SettingMembershipCardSingle extends StatefulWidget {
  ...
  const SettingMembershipCardSingle(
...
class SettingMembershipCardSingleState
    extends State<SettingMembershipCardSingle> {
  ...
  Widget build(BuildContext context) {
    String levelhint = "${AppSettingTheme.getTheme(
      context,
      Config.MAX_LEVEL_KEY,
      Config.MAX_LEVEL_VALUE,
    )}";

    levelhint = "${AppSettingTheme.getTheme(
      context,
      Config.TOTAL_EARNING_POINTS_KEY,
      Config.TOTAL_EARNING_POINTS_VALUE,
    )} ${RefreshApp.of(context)?.apiAppVariables.user?.totalCollectedPoints.toString()}  level reset:${RefreshApp.of(context)?.apiAppVariables.user?.pointsValidationDate} \n ${AppSettingTheme.getTheme(
      context,
      Config.EARN_KEY,
      Config.EARN_VALUE,
    )} ${RefreshApp.of(context)?.apiAppVariables.userCurrentLevel?.nextLevelRemain.toString()} ${AppSettingTheme.getTheme(
      context,
      Config.MORE_TO_REACH_KEY,
      Config.MORE_TO_REACH_VALUE,
    )}";

    try {
      gradiant = [
        Color(int.parse(RefreshApp.of(context)!
                .apiAppVariables
                .userCurrentLevel
                ?.startColor
                .toString() ??
      ...
      child: Container(
        ...
        child: Transform.translate(
          ...
          child: Container(
            ...
            child: BaseText(
              color: Color(int.parse(RefreshApp.of(context)!
                  .apiAppVariables
                  .userCurrentLevel!
                  .sideFontColor
                  .toString())),
              text:
                  "${RefreshApp.of(context)!.apiAppVariables.userCurrentLevel!.name}",
              margin: 5,
              marginh: 0,
              fontSize: 20,
              onPressed: () {},
    ...
    double progress = (double.parse(RefreshApp.of(context)!
                .apiAppVariables
                .userCurrentLevel!
                .userTotalPoints
                .toString()) -
                                      ...
                                      children: [
                                        ...
                                        BaseText(
                                          ...
                                          text: "${AppSettingTheme.getTheme(
                                            context,
                                            Config.AVAILABLE_POINTS_KEY,
                                            Config.AVAILABLE_POINTS_VALUE,
                                          )}",
                                          margin: 5,
                                          marginh: 25,
                                          fontSize: 12,
                                      ...
                                      child: BaseText(
                                        color: Color(int.parse(
                                            RefreshApp.of(context)!
                                                ...
                                                .toString())),
                                        text:
                                            "${RefreshApp.of(context)!.apiAppVariables.userCurrentLevel!.benefits}",
                                        margin: 5,
                                        marginh: 25,
                                        fontSize: 9,
                                        onPressed: () {},
                                ...
                                children: [
                                  Container(
                                    child: BaseText(
                                      ...
                                      text: "${AppSettingTheme.getTheme(
                                        context,
                                        Config.MEMBERSHIP_DETAILS_KEY,
                                        Config.MEMBERSHIP_DETAILS_VALUE,
                                      )}",
                                      margin: 5,
                                      marginh: 10,
                                      fontSize: 9,
