...
class PerasonalDetailsFormState extends State<PerasonalDetailsForm> {
  ...
  initState() {
    ...
    fname = BaseEditText(
        ...
        controller: TextEditingController(
            text: RefreshApp.of(context)!.apiAppVariables.user!.firstName),
    ...
    lname = BaseEditText(
        ...
        validationType: ValidationType.TEXT,
        controller: TextEditingController(
            text: RefreshApp.of(context)!.apiAppVariables.user!.lastName),
        type: TextBoxType.TEXT,
        maxLines: 1,
        width: 305,
        height: 55);
    ...
    city = BaseEditText(
        ...
        validationType: ValidationType.TEXT,
        controller: TextEditingController(
            text: RefreshApp.of(context)!.apiAppVariables.user!.city),
        type: TextBoxType.TEXT,
        maxLines: 1,
        width: 305,
        height: 55);
    state = BaseEditText(
        ...
        validationType: ValidationType.TEXT,
        controller: TextEditingController(
            text: RefreshApp.of(context)!.apiAppVariables.user!.state),
        type: TextBoxType.TEXT,
        maxLines: 1,
        width: 305,
        height: 55);
    street = BaseEditText(
        ...
        validationType: ValidationType.TEXT,
        controller: TextEditingController(
            text: RefreshApp.of(context)!.apiAppVariables.user!.street),
        type: TextBoxType.TEXT,
        maxLines: 2,
        width: 305,
        height: 55);
    building = BaseEditText(
        text: "building",
        margin: 5,
        marginh: 20,
        focusNode: FocusNode(),
        ...
        validationType: ValidationType.TEXT,
        controller: TextEditingController(
            text: RefreshApp.of(context)!.apiAppVariables.user!.building),
        type: TextBoxType.TEXT,
        maxLines: 1,
        width: 305,
        height: 55);
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
        ...
        child: ListView(children: <Widget>[
          ...
          Container(margin: EdgeInsets.all(0), child: fname),
          Container(
            margin: EdgeInsets.only(left: 20, right: 20),
            alignment: Alignment.topLeft,
            child: FooterText(
          ...
          Container(margin: EdgeInsets.all(0), child: lname),
          Container(
            margin: EdgeInsets.only(left: 20, right: 20),
            alignment: Alignment.topLeft,
            child: FooterText(
              ...
              child: InkWell(
                  onTap: () async {
                    pickedDate = await showDatePicker(
                        ...
                        .then((value) {
                      print(
                          value); //get the picked date in the format => 2022-07-04 00:00:00.000
                      String formattedDate = DateFormat('yyyy-MM-dd').format(
                          value!); // format date in required form here we use yyyy-MM-dd that means time is removed
                      print(
          ...
          Container(margin: EdgeInsets.all(0), child: city),
          Container(
            margin: EdgeInsets.only(left: 20, right: 20),
            alignment: Alignment.topLeft,
            child: FooterText(
          ...
          Container(margin: EdgeInsets.all(0), child: state),
          Container(
            margin: EdgeInsets.only(left: 20, right: 20),
            alignment: Alignment.topLeft,
            child: FooterText(
          ...
          Container(margin: EdgeInsets.all(0), child: street),
          Container(
            margin: EdgeInsets.only(left: 20, right: 20),
            alignment: Alignment.topLeft,
            child: FooterText(
          ...
          Container(margin: EdgeInsets.all(0), child: building),
          MainButton(
            text: "SAVE",
            onPressed: () async {
              if (Validator.validateForm(
                  context, [fname, lname, city, state, street, building], [])) {
                updateProfile();
              }
  ...
  updateProfile() async {
    ...
    var responce = await dio.post("profile", data: {
      "state": state.controller.text.toString(),
      ...
      if (HttpAPI().APIValidateResponce(value)) {
        ...
        MainDialog.showMyDialog(
            MainDialog(
                ...
                descriptions: "edit profile Error",
                text: "",
