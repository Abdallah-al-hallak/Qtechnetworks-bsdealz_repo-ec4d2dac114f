/// id : 1
/// name : "BLUE"
/// benefits : "get back 1.5% of your purchase"
/// name_ref_id : 25
/// benefits_ref_id : 26
...
/// side_color_start : "0XFF3EF0FF"
/// side_color_end : "0XFF2DAAF8"
/// side_font_color : "0XFF0068D0"
/// content_font_color : "0XFFFFFFFF"
/// center_box_color : "0XFF0E549A"
/// created_at : null
/// updated_at : "2022-09-26T22:51:13.000000Z"
/// user_total_points : 2039
/// next_level_remain : 461
/// points_currency_amount : "2,700.05 USD"

class ApiUserCurrentLevel {
  ApiUserCurrentLevel({
    int? id,
    String? name,
    String? benefits,
    ...
    String? updatedAt,
    int? userTotalPoints,
    String? nextLevelRemain,
    String? pointsCurrencyAmount,}){
    _id = id;
    _name = name;
    _benefits = benefits;
    ...
    _nextLevelRemain = nextLevelRemain;
    _pointsCurrencyAmount = pointsCurrencyAmount;
  }

  ApiUserCurrentLevel.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
    ...
    _userTotalPoints = json['user_total_points'];
    _nextLevelRemain = json['next_level_remain'];
    _pointsCurrencyAmount = json['points_currency_amount'];
  }
  int? _id;
  String? _name;
  String? _benefits;
  ...
  String? _nextLevelRemain;
  String? _pointsCurrencyAmount;
  ApiUserCurrentLevel copyWith({  int? id,
    String? name,
    String? benefits,
    int? nameRefId,
    int? benefitsRefId,
    ...
    userTotalPoints: userTotalPoints ?? _userTotalPoints,
    nextLevelRemain: nextLevelRemain ?? _nextLevelRemain,
    pointsCurrencyAmount: pointsCurrencyAmount ?? _pointsCurrencyAmount,
  );
  int? get id => _id;
  ...
  String? get nextLevelRemain => _nextLevelRemain;
  String? get pointsCurrencyAmount => _pointsCurrencyAmount;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['user_total_points'] = _userTotalPoints;
    map['next_level_remain'] = _nextLevelRemain;
    map['points_currency_amount'] = _pointsCurrencyAmount;
    return map;
  }
