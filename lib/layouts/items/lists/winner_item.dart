...
class _WinnerItemState extends State<WinnerItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        onTap: () {},
        child: WinnerItemSingle(
          height: widget.height,
          width: widget.width,
          text: widget.winnerItem!.campaign!.name.toString(),
          winnerItem: widget.winnerItem!,
        ));
  }
}
            ...
            child: Column(
              children: [
                            ...
                            child: Container(
                              ...
                              child: Image(
                                image: CachedNetworkImageProvider(
                                    HttpAPI().BASE_URL +
                                        widget.winnerItem.campaign!.image
                                            .toString()),
                                alignment: Alignment.center,
                                fit: BoxFit.contain,
                ...
                BaseText(
                  ...
                  text: "${AppSettingTheme.getTheme(
                    context,
                    Config.ON_WINNING_KEY,
                    Config.ON_WINNING_VALUE,
                  )}  ${widget.winnerItem.campaign!.prize.toString()}}",
                  margin: 10,
                  marginh: 5,
                  fontSize: 14,
                  onPressed: () {},
                ...
                BaseText(
                  ...
                  text: "${AppSettingTheme.getTheme(
                    context,
                    Config.ANNOUNCED_KEY,
                    Config.ANNOUNCED_VALUE,
                  )} ${widget.winnerItem.drawDate}",
                  margin: 0,
                  marginh: 5,
                  fontSize: 11,
                  onPressed: () {},
