        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                Container( child: TitleText(text: "${AppSettingTheme.getTheme(context,Config.SOLD_OUT_KEY,Config.SOLD_OUT_VALUE,)}", onPressed: (){}, clickable: false)),
                //     Flexible(
                //       flex: 1,
                //   child: Container(
                //
  ...
  Widget CampaignItem(ApiCampaign campaign) {
    ...
    return GestureDetector(
                ...
                children: [
                  ...
                  Card(
                      ...
                      child:  Container(
                        ...
                        child: BaseText(
                    color: Colors.black,
                    text:"${AppSettingTheme.getTheme(context,Config.DRAW_DATE_KEY,Config.DRAW_DATE_VALUE,)} ${campaign.drawDate}",
                    margin: 0,
                    marginh: 5,
                    fontSize: 13,
                    onPressed: (){},
      ...
      Card(
        ...
        shape:RoundedRectangleBorder(
          // side: BorderSide(color: Colors.green, width: 0.5),
            borderRadius: BorderRadius.circular(21)),child: Container(
        width: width-10,
        height: width-10,
        margin: EdgeInsets.all(5),
        padding: EdgeInsets.all(5),) ,)
