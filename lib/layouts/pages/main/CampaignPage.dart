...
class CampaignPage extends StatefulWidget {
  ...
  CampaignPage({
    Key? key, required this.campaign,
  }) : super(key: key);
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    for (int i=0;i<RefreshApp.of(context)!.localCart.items!.length;i++){
      if(RefreshApp.of(context)!.localCart!.items!.elementAt(i).campaignId==widget.campaign!.id) {
        quantity=RefreshApp
            .of(context)!
       .localCart!
            .items!
    ...
    if(widget.campaign!.isCountdown!){
      mainIndecator=TimerIdicator(height: 30,criticalValue: 0.6,progress: 0.2, campaign: widget.campaign!,);
    }else{
      Color color=Colors.green;
      double progress= double.parse(widget.campaign!.sold.toString())/double.parse(widget.campaign!.quantity.toString());
      ...
      mainIndecator=MainProgressIndicator(height: 50,campagin: widget.campaign!,criticalValue: 0.6,progress: 0.2,color: color,scale:  1.0,);
    ...
    Widget prizeWidget=ListView(children: [
      mainIndecator,

      SubTitleText(text: widget.campaign!.name.toString(), onPressed: (){}, clickable: false),
    ...
    Widget productWidget=ListView(children: [
      SubTitleText(text: widget.campaign!.products!.first.productName.toString(), onPressed: (){}, clickable: false),
      BaseText(
        color: Color(0XFF707070),
    ...
    if(widget.campaign!.images!.length>0){
      gallery=     CampaignSlider(isRadius:true,height: 300, images:widget.campaign!.images!,);
    }else {
      gallery = Image(
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              BackBar(height: 40,title: "",notificationsNumber: 0,showCart: true,),
              Stack(
                children: [
                  Container(
                    child: PhysicalModel(
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          margin: EdgeInsets.only(top:10,right: 20,left: 20,bottom: 15),
                          height: 210,
                          child: gallery,
                        ),
                      ),
                  ...
                  Container(
                      ...
                      child: LikeButton(isActive: isLiked,campaignId:int.parse(widget.campaign!.id.toString(),)))
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                              AppIcon(icon: AppIcon.CALENDAR_PATH, size: 18),
                              BaseText(
                                color: Color(0XFF707070),
                                text: "Max draw date: "+widget.campaign!.drawDate.toString(),
                                margin: 10,
                                marginh: 5,
                                fontSize: 9,
                                onPressed: (){},
                        ...
                        SubTitleText(text: "Buy ${widget.campaign!.products!.first.productName}", onPressed: (){}, clickable: false),
                        BaseText(
                          color: Colors.black,
                          text:" ${RefreshApp.of(context)!.apiHeaders.acceptCurrency}"+widget.campaign!.price.toString().replaceAll(RegExp(r'([.]*0+)(?!.*\d)'), ''),
                          margin: 5,
                          marginh: 20,
                          fontSize: 25,
                          onPressed: (){},
                          ...
                          AddToCartButton(campaign:widget.campaign!, height: 60,)
                      ],),
                    ),
