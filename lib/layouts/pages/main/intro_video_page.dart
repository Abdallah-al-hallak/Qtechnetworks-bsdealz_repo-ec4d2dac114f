...
class _IntroVideoPageState extends State<IntroVideoPage> {
  ...
  String ImageUrl="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4";
  ...
  void initState() {
    ...
    if(isVideo) {
      _controller = VideoPlayerController.network(videoUrl)..initialize().then((_) {
  ...
  Widget build(BuildContext context) {
    ...
    if(isVideo) {
      ...
      double deviceAspect=MediaQuery.of(context).size.width/MediaQuery.of(context).size.height;
         ...
         children: [
           ...
           Center(
             child: Container(
               ...
               child:MainButton(isActive: true,text: "SKIP VIDEO",onPressed: (){
