                  ...
                  children: <Widget>[
                    ...
                    Container(
                      margin: EdgeInsets.all(5),
                        ...
                        child: TitleText(text: RefreshApp.of(context)!.apiAppVariables.user!.firstName.toString(),onPressed: (){},clickable: false,)),
                    Container(
                        margin: EdgeInsets.all(5),
                        alignment: Alignment.center,
                        child: SubTitleText(text: RefreshApp.of(context)!.apiAppVariables.user!.email.toString(),onPressed: (){},clickable: false,)),

                    SettingMembershipCard(height: 170,width: 1,),
                    Container(height: 15,),
                    BaseText(
                      color: Colors.black,
                      text:"Profile",
                        ...
                        child: Column(
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title:SettingText(text: "Personal details",clickable: false,onPressed: (){})
                                   ,
                                    trailing:Icon(
                                      size:20,
                                    ...
                                    onTap: () {
                                      if (kIsWeb) {
                                        WebDialog.showMyDialog(WebDialog(title: "",
                                            text: "Dismiss",
                                            descriptions: "",
                                            customWidget:  PersonalDetailsPage(),),
                                            context);
                                      } else {
                                      Navigator.push(
                                        context,
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "My Wishlist",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "Saved cards/Payment methods",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "Change password",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                                    ...
                                    onTap: () {
                                      if (kIsWeb) {
                                        WebDialog.showMyDialog(WebDialog(title: "",
                                          text: "Dismiss",
                                          descriptions: "",
                                          customWidget:  ChangePasswordPage(),),
                                            context);
                                      } else {
                                        Navigator.push(
                                          context,
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "My Wallet",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                        ...
                        child: Column(
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "How it works",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                                    ...
                                    onTap: () {
                                      if (kIsWeb) {
                                        WebDialog.showMyDialog(WebDialog(title: "",
                                          text: "Dismiss",
                                          descriptions: "",
                                          customWidget: ContentWebView(url:HttpAPI().BASE_URL.replaceAll("http://", "").replaceAll("https://", "") +"/hot-it-works.pdf"),),
                                            context);
                                      } else {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => ContentWebView(url:HttpAPI().BASE_URL.replaceAll("http://", "").replaceAll("https://", "") +"/hot-it-works.pdf"),
                                          ),
                                        );}
                                    }),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "Our charity work",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                                    ...
                                    onTap: () {
                                      if (kIsWeb) {
                                        WebDialog.showMyDialog(WebDialog(title: "",
                                          text: "Dismiss",
                                          descriptions: "",
                                          customWidget: ContentWebView(url:HttpAPI().BASE_URL.replaceAll("http://", "").replaceAll("https://", "") +"/our-charity.pdf"),),
                                            context);
                                      } else {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => ContentWebView(url:HttpAPI().BASE_URL.replaceAll("http://", "").replaceAll("https://", "") +"/our-charity.pdf"),
                                          ),
                                        );}
                                    }),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "Contact us",clickable: false,onPressed: (){}),
                                    trailing:Icon(
                                      size:20,
                                      Icons.arrow_forward_ios,
                                      color: Colors.grey,
                        ...
                        child: Column(
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "Language",clickable: false,onPressed: (){}),
                                    trailing:Container( width:100,child: LanguageIndicator(height: 40)),
                                    onTap: () {
                                    }),
                              ),
                            ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: ListTile(
                                    title: SettingText(text: "Currency",clickable: false,onPressed: (){}),
                                    trailing:Container( width:100,child: CurrencyIndicator(height: 40)),
                                    onTap: () {
                                      showDialog(
                                        context: context,
                                        builder: (BuildContext context) {
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                      title: Text("Logout",style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold,fontSize: 16),),
