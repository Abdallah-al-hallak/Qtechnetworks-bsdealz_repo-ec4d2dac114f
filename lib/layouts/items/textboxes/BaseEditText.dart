  ...
  static getBox(int type) {
    if (type == 1)
      return RoundedRectangleBorder(
          ...
          side: BorderSide(width: 2, color: Color(0XFF174785)));
    return RoundedRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(8)),
  ...
  Widget build(BuildContext context) {
    ...
    switch (textBoxType) {
      ...
      case TextBoxType.PHONE:
        ...
        inputDecoration = InputDecoration(
            ...
            labelText: "${AppSettingTheme.getTheme(
              context,
              Config.PHONE_KEY,
              Config.PHONE_VALUE,
            )}",
      ...
      case TextBoxType.EMAIL:
        ...
        inputDecoration = InputDecoration(
          counterText: '',
          hintText: "${AppSettingTheme.getTheme(
            context,
            Config.EMAIL_KEY,
            Config.EMAIL_VALUE,
          )}"
    ...
    return Container(
        ...
        margin: EdgeInsets.only(
            top: widget.margin, right: widget.marginh, left: widget.marginh),
        child: TextFormField(
