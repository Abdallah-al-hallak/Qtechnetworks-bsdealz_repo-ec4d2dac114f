...
class TextDialog extends StatefulWidget {
  ...
  const TextDialog({Key? key, required this.title, required this.descriptions, required this.text, required this.img}) : super(key: key);
      ...
      children: <Widget>[
        Container(
          ...
          child: Container(
            child: ListView(
              children: [
                CustomTextbox(text:widget.title,margin: 5,marginh: 20,controller: TextEditingController(),maxLines: 5, iconData:Icons.info_outline, validator: '',type:cTextBoxType.TEXT),
                ...
                Container(
                  ...
                  child: Row(children: [
                    Expanded(
                      ...
                      }, icon: Icons.info_outline, width: 150,),
                    ),
                    Expanded(
                      flex: 1,
                      child: DialogBtn(
