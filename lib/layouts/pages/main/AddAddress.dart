...
class AddressFormState extends State<AddressForm> {
  ...
  BaseEditText nameet=BaseEditText(text: "Address name", margin: 5, marginh: 20, focusNode:FocusNode(),isValidationDialog: true,validationType: ValidationType.TEXT, controller: TextEditingController(), type: TextBoxType.TEXT, maxLines: 1, width: 305, height: 55);
  BaseEditText city=BaseEditText(text: "City", margin: 5, marginh: 20, focusNode:FocusNode(),isValidationDialog: true,validationType: ValidationType.TEXT, controller: TextEditingController(), type: TextBoxType.TEXT, maxLines: 1, width: 305, height: 55);
  BaseEditText state=BaseEditText(text: "State", margin: 5, marginh: 20, focusNode:FocusNode(),isValidationDialog: true,validationType: ValidationType.TEXT, controller: TextEditingController(), type: TextBoxType.TEXT, maxLines: 1, width: 305, height: 55);
  BaseEditText street=BaseEditText(text: "Street", margin: 5, marginh: 20, focusNode:FocusNode(),isValidationDialog: true,validationType: ValidationType.TEXT, controller: TextEditingController(), type: TextBoxType.TEXT, maxLines: 2, width: 305, height: 55);
  BaseEditText building=BaseEditText(text: "Building", margin: 5, marginh: 20, focusNode:FocusNode(),isValidationDialog: true,validationType: ValidationType.TEXT, controller: TextEditingController(), type: TextBoxType.TEXT, maxLines: 1, width: 305, height: 55);
  BaseEditText apartmentNumber=BaseEditText(text: "Apartment Number", margin: 5, marginh: 20, focusNode:FocusNode(),isValidationDialog: true,validationType: ValidationType.TEXT, controller: TextEditingController(), type: TextBoxType.TEXT, maxLines: 1, width: 305, height: 55);
  ...
  addAddress() async {
    ...
    if(cityValue==""||cityValue==null){
      MainDialog.showMyDialog(MainDialog(title: "Add address failed", descriptions: "Select city please", text: "", type: DialogType.ERROR, customWidget: Container())
          , context);
      return 0;
    }
    var responce = await dio.post("address",
      ...
      if (HttpAPI().APIValidateResponce(value)) {
        ...
        MainDialog.showMyDialog(MainDialog(title: "Add Address failed", descriptions: "Add Address Error", text: "", type: DialogType.ERROR, customWidget: Container())
            , context);
      ...
      EasyLoading.dismiss();
      log(error.toString());
      MainDialog.showMyDialog(MainDialog(title: "Add Address failed", descriptions: error.toString(), text: "", type: DialogType.ERROR, customWidget: Container())
          , context);
    });
  }
